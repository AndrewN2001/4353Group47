...
function EventManagementForm() {
  const {isAdmin, isLoggedIn, darkMode} = useAuth();
      ...
      <div className="max-w-4xl mx-auto p-6 lg:p-12">
        <div className={`shadow-xl p-8 rounded-sm flex flex-col gap-6 ${darkMode ? "bg-gray-800" : "bg-white"}`}>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            {/* Event Name */}
            <div>
              <label className={`block text-sm font-medium mb-1 ${darkMode ? "text-gray-300" : null}`}>Event Name</label>
              <input
                type="text"
                maxLength="100"
                value={eventName}
            ...
            {/* Event Description */}
            <div>
              <label className={`block text-sm font-medium mb-1 ${darkMode ? "text-gray-300" : null}`}>Event Description</label>
              <textarea
            ...
            {/* Location */}
            <div>
              <label className={`block text-sm font-medium mb-1 ${darkMode ? "text-gray-300" : null}`}>Location</label>
              <textarea
                value={location}
            ...
            {/* Required Skills */}
            <div>
              <label className={`block text-sm font-medium mb-1 ${darkMode ? "text-gray-300" : null}`}>Required Skills</label>
              <select
                multiple
            ...
            {/* Urgency */}
            <div className={`${darkMode ? "text-gray-300" : null}`}>
              <label className={`block text-sm font-medium mb-1 ${darkMode ? "text-gray-300" : null}`}>Urgency</label>
              <select
                value={urgency}
              ...
              >
                ...
                {urgencyOptions.map((level, index) => (
                  <option key={index} value={level} className={`${darkMode ? "text-gray-300" : null}`}>
                    {level}
                  </option>
                ))}
              </select>
            ...
            {/* Event Date */}
            <div>
              <label className={`block text-sm font-medium mb-1 ${darkMode ? "text-gray-300" : null}`}>Start Date</label>
              <div className='flex items-center gap-3'>
                ...
                <div className="relative">
                  ...
                  <input 
                    type="time" 
                    id="time" 
                    className="border-2 leading-none border-gray-700 text-gray-900 focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" 
                    min="09:00" 
                    max="18:00" 
                    value={startTime}
            ...
            <div>
              <label className={`block text-sm font-medium mb-1 ${darkMode ? "text-gray-300" : null}`}>End Date</label>
              <div className='flex items-center gap-3'>
                <input
                  type="date"
                  value={endDate}
