                    ...
                    <div id="username_info" className="border-r-2 row-span-3 col-span-1 flex flex-col items-center h-full min-w-fit">
                        ...
                        <div id="page_selection" className="h-1/2 w-full flex justify-center items-end pb-7">
                            <ul className="text-2xl flex flex-col w-full">
                                <li>
                                    <button className="flex gap-2 items-center justify-center hover:bg-blue-500 w-full py-3" onClick={() => setSelected("dashboard")}>
                                        <BsPersonFill />
                                        User Dashboard
                                    </button>
                                </li>
                                <li>
                                    <button className="flex gap-2 items-center justify-center hover:bg-blue-500 w-full py-3" onClick={() => setSelected("notifications")}>
                                        <IoIosNotifications />
                                        Notifications
                                    </button>
                                </li>
                                <li>
                                    <button className="flex gap-2 items-center justify-center hover:bg-blue-500 w-full py-3" onClick={handleLogOut}>
                                    <IoClose />
                                        Log Out
                                    </button>
                                </li>
